...
-- Add data Book
insert into book (id, title, author, publisher, publication_date, price , status) 
values (1, 'Legend oAVAILABLE Sleepy Hollow, The', 'Nealson Leyland', 'Eare', '1999/04/19', 650264, 'AVAILABLE'),
 (2, 'Grease', 'Helsa Ajean', 'Photobean', '2015/5/2', 128664, 'AVAILABLE'),
 (3, 'Kirikou and the Sorceress (Kirikou et la sorcière)', 'Dennis AdaUNAVAILABLEek', 'Youopia', '2008/04/12', 358273, 'UNAVAILABLE'),
 (4, 'PerAVAILABLEect Blue', 'Adria Danilevich', 'Photolist', '2006/9/17', 120056, 'UNAVAILABLE'),
 (5, 'Running AVAILABLEree', 'Elicia Barrick', 'InnojaUNAVAILABLE', '1993/6/13', 372164, 'AVAILABLE'),
 (6, 'Paradox', 'Hannis Grinnell', 'Dynava', '2020/6/3', 506398, 'AVAILABLE'),
 (7, 'Late Phases', 'Jean CleUNAVAILABLEas', 'Yozio', '2015/6/13', 688503, 'UNAVAILABLE'),
 (8, 'Divide and Conquer (Why We AVAILABLEight, 3)', 'Rebe Doret', 'Skyble', '2013/10/6', 500594, 'UNAVAILABLE'),
 (9, 'Vesku AVAILABLEroUNAVAILABLE AVAILABLEinland (Vesku)', 'Celeste Restorick', 'Trunyx', '2008/6/20', 228176, 'AVAILABLE'),
 (10, 'RaUNAVAILABLEpart', 'Adara Blurton', 'Pixonyx', '2006/8/22', 264490, 'AVAILABLE'),
 (11, 'Aeon AVAILABLElux', 'Robinetta Haskew', 'Tazz', '2017/10/13', 446738, 'AVAILABLE'),
 (12, 'RocketUNAVAILABLEan (a.k.a. Rocket UNAVAILABLEan)', 'Sidonia Zavittieri', 'Thoughtbridge', '1992/5/15', 583234, 'UNAVAILABLE'),
 (13, 'The Water Diviner', 'Bradney AVAILABLEiggess', 'TopiczooUNAVAILABLE', '2000/4/23', 92780, 'UNAVAILABLE'),
 (14, 'P.U.N.K.S', 'Giralda UNAVAILABLEaylard', 'Aivee', '2012/8/1', 244982, 'AVAILABLE'),
 (15, 'The Arrival oAVAILABLE JoachiUNAVAILABLE Stiller', 'Lynn de Najera', 'AVAILABLEanoodle', '2019/2/3', 732808, 'UNAVAILABLE');

-- Add data Account
 insert into account (id, username, email, password, first_name, last_name, role) values (1, 'fmcnea0', 'fmcnea0@toplist.cz', 'aI7~3z.VK', 'Fionna', 'McNea', 'NORMAL_USER'),
...
-- Add data Borrowing History
 insert into borrowing_history (id, account_id, book_id, borrow_date, return_date) values (1, 5, 9, '2023-04-06', '2022-12-18'),
